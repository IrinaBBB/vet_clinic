...
function Navbar() {
    ...
    return (
        <>
            <div className="flex w-full items-center bg-gradient-to-r from-indigo-700/90 to-indigo-600/90 py-3 px-10 sm:px-20 font-montserrat text-white text-lg uppercase relative z-[100] justify-between sm:justify-between">
                <div className="flex">
                    <img
                        src={logo_light}
                        alt="logo"
            ...
            >
                {navLinks.map((link: NavigationLink) => (
                    ...
                    >
                        <Link
                            to={link.path}
                            className="bg-gradient-to-r from-indigo-700/90 to-indigo-600/90 text-white py-2 px-10 rounded-full"
                        >
                            {link.title}
                        </Link>
                    </li>
