                    ...
                    >
                        <div className=" flex items-center">
                            <img
                                src={logo_dark}
                                alt=" vet"
                                className=" w-20 bg-indigo-50 ms-7 sm:ms-3 me-7 border-
                                        [1px] border-indigo-600 p-6 rounded-full"
                            />
                            <div>
