                ...
                <li>
                    <ul className="flex justify-center items-center">
                        {paginationNumbers.map((number) => (
                            <li className="me-3 last:me-0 relative p-4 bg-gradient-to-r from-indigo-700 to-blue-700 rounded-full cursor-pointer hover:scale-125 transition-all duration-200">
